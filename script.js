...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let cartTotal = 0; // to track total amount

    totalDisplay.id = "cart-total";
    totalDisplay.textContent = "Total: $0.00";
    cartItems.after(totalDisplay); // add total display below cart items
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener("click", (e) => {
            ...
            const cartItem = document.createElement("div");
            cartItem.className = "cart-item";
            cartItem.innerHTML = `<p>${productName} - ${productPriceText}</p>`;
            cartItems.appendChild(cartItem);
    ...
    closeThankYou.addEventListener("click", () => {
        ...
        totalDisplay.textContent = "Total: $0.00"; // Reset displayed total
    });
});
